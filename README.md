...
### Central Question
Have football matches become less foul-prone over time?
...
`python fbref_scraper.py -s start_year -e end_year`
...
- The **Premier League** and **Bundesliga** have seen the sharpest decline.
